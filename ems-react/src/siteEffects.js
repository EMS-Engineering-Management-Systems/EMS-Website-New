...
const MV_MODAL_CONTENT = {
    mission: {
        title: 'Our Mission',
        img: '/datacenter5.png',
        text: 'Combining the light of the principle of professionalism and the corporate vision, a very good way to analyze the needs of our customers and without compromising customer satisfaction to serve economical, fast, and high-quality solutions. To exclusively handle full-fledged MEP works in accordance with the latest technologies and to make our Professional Project Management Services an essential key for our partners\'/clients\' success.',
    },
    vision: {
        title: 'Our Vision',
        img: '/datacenter2.png',
